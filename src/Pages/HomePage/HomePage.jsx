  ...
  return (
    <>
      ...
      <div>
        ...
        <section>
          <div
            className={`${s.section3} ${s.animateSection ? s.animateIn : ""}`}
          >
            <h2 className={s.categories}>Popular Categories</h2>
            <div className={s.cards}>
              <div className={s.card}>
                <div className={s.card__title}>Soups</div>
                <div className={s.card__subtitle}>
                  Perfect for a cozy night in
                </div>
                <div className={s.card__categories}>Tomato, Chicken Noodle</div>

                <div className={s.card__footer}>
                  <a
                    href="https://www.bbcgoodfood.com/recipes/collection/soup-recipes"
              ...
              <div className={s.card2}>
                <div className={s.card__title}>Desserts</div>
                <div className={s.card__subtitle}>
                ...
                <div className={s.card__footer}>
                  <a
                    href="https://www.delish.com/cooking/recipe-ideas/g3246/easy-desserts/"
                    className={s.card__link}
                  >
                    See More &gt;
                  </a>
              ...
              <div className={s.card2}>
                <div className={s.card__title}>Vegeterian</div>
                <div className={s.card__subtitle}>Healthy lifestyle</div>
                <div className={s.card__categories}>Salads, healthy food</div>
                <div className={s.card__footer}>
                  <a
